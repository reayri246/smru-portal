...
DATABASE_URL = config('DATABASE_URL', default='postgresql://smruportal.rdbaiycxqfykiiwszzos:jGZmDnNiXjTDJm4z@aws-1-ap-south-1.pooler.supabase.com:6543/postgres')
